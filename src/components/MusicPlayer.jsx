...
export default function MusicPlayer() {
    ...
    const [position, setPosition] = useState({ x: null, y: null }) // null means use default CSS position
    ...
    // Floating toggle button styles - positioned above stock ticker (or custom position if dragged)
